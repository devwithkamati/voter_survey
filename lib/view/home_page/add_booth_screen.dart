...
import '../../controller/add_booth_controller.dart';
...
import '../../controller/panchayat_for_booth_controller.dart';
...
class _AddBoothScreenState extends State<AddBoothScreen> {
  ...
  final PanchayatBoothController panchayatController = Get.put(
    PanchayatBoothController(),
  );
  final AddBoothController addBoothController = Get.put(AddBoothController());
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // AddBoothScreen._buildDropdown("Select State", Icons.location_on_outlined),
                    ...
                    Obx(
                      () => DropdownButtonFormField<int>(
                        ...
                        onChanged: (value) {
                          ...
                          panchayatController.selectedPanchayatId.value = null;

                          panchayatController.panchayatList.clear();

                          if (value != null) {
                            panchayatController.getPanchayats(value);
                          }
                        },
                      ),
                    ),
                    ...
                    Obx(
                      () => DropdownButtonFormField<int>(
                        value:
                            panchayatController.panchayatList.any(
                              (e) =>
                                  e.id ==
                                  panchayatController.selectedPanchayatId.value,
                            )
                            ? panchayatController.selectedPanchayatId.value
                            : null,
                        ...
                        items: panchayatController.panchayatList.map((
                          panchayat,
                        ) {
                          return DropdownMenuItem<int>(
                            value: panchayat.id,
                        ...
                        onChanged: (value) {
                          panchayatController.selectedPanchayatId.value = value;
                        },
                      ),
                    ),
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          if (stateController.selectedStateId.value == null ||
                              ...
                              panchayatController.selectedPanchayatId.value ==
                                  null ||
                              addBoothController.boothNameController.text
                                  .trim()
                                  .isEmpty) {
                            Get.snackbar(
                              "Validation",
